  ...
  return (
    <div className="space-y-6">
      ...
      <Modal isOpen={showReceipt} onClose={() => setShowReceipt(false)} title="Receipt" size="sm">
        <div ref={receiptRef}>
          <div className="text-center border-b border-dashed pb-3 mb-3"><h3 className="font-bold text-base" style={{color:'#059669'}}>{pharmaName}</h3><p className="text-xs text-gray-500">Receipt #{lastSale?.receiptNumber}</p><p className="text-xs text-gray-500">{formatDate(new Date())}</p></div>
